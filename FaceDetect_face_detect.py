<!DOCTYPE html>
<!-- saved from url=(0064)https://github.com/shantnu/FaceDetect/blob/master/face_detect.py -->
<html lang="en" class="gr__github_com"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link crossorigin="anonymous" media="all" integrity="sha512-7uoDIEGQ8zTwUS9KjTP+/2I13FQPHvJ9EKoeUThfin5R1+27bcUC08VQzUo4CIjCdhvJM4zxuI+3HcSycAUTCg==" rel="stylesheet" href="./FaceDetect_face_detect_files/frameworks-abba74d6e28a6842788159fec056bf26.css">
  
    <link crossorigin="anonymous" media="all" integrity="sha512-B3a+f3UDoF4bqYqd/Kj/eZUQqWtIyhqIOcNVS06WD3AS/khK0ILLekQai0VUkszcU+IgY3l4pULlh0gchUbvWA==" rel="stylesheet" href="./FaceDetect_face_detect_files/github-93c081ae3ae0913e3d16002f0425837e.css">
  ...
  <meta class="js-ga-set" name="userId" content="453457a1e5fdf65eb71824b3f14cda02">
...
<meta class="js-ga-set" name="dimension1" content="Logged In">
  ...
  <meta name="html-safe-nonce" content="63ce8dc9ba8b2e0a71d8e0997575253ba372672c">
...
<li class="d-flex flex-justify-start flex-items-center p-0 f5 navigation-item js-navigation-item js-jump-to-suggestion" role="option">
  <a tabindex="-1" class="no-underline d-flex flex-auto flex-items-center jump-to-suggestions-path js-jump-to-suggestion-path js-navigation-open p-2" href="https://github.com/shantnu/FaceDetect/blob/master/face_detect.py">
    ...
    <img class="avatar mr-2 flex-shrink-0 js-jump-to-suggestion-avatar d-none" alt="" aria-label="Team" src="https://github.com/shantnu/FaceDetect/blob/master/face_detect.py" width="28" height="28">
...
<li class="d-flex flex-justify-start flex-items-center p-0 f5 navigation-item js-navigation-item js-jump-to-global-search d-none" role="option">
  <a tabindex="-1" class="no-underline d-flex flex-auto flex-items-center jump-to-suggestions-path js-jump-to-suggestion-path js-navigation-open p-2" href="https://github.com/shantnu/FaceDetect/blob/master/face_detect.py">
    ...
    <li class="d-flex flex-justify-center flex-items-center p-0 f5 js-jump-to-suggestion">
      <img src="./FaceDetect_face_detect_files/octocat-spinner-128.gif" alt="Octocat Spinner Icon" class="m-2" width="28">
    </li>
</ul>
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown">
    ...
    <a aria-label="You have no unread notifications" class="Header-link notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:20263077" href="https://github.com/notifications">
...
<a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <div class="dropdown-header">
    <span title="shantnu/FaceDetect">This repository</span>
  </div>
    <a role="menuitem" class="dropdown-item" href="https://github.com/shantnu/FaceDetect/issues/new" data-ga-click="Header, create new issue" data-skip-pjax="">
      New issue
    </a>
  ...
  <li class="dropdown">
      <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
        <summary class="HeaderNavlink name" aria-label="View profile and more" data-ga-click="Header, show menu, icon:avatar" aria-haspopup="menu">
          <img alt="@kareemassad" class="avatar float-left mr-1" src="./FaceDetect_face_detect_files/20263077" height="20" width="20">
          <span class="dropdown-caret"></span>
        </summary>
        <details-menu class="dropdown-menu dropdown-menu-sw" role="menu">
          <div class="header-nav-current-user css-truncate"><a role="menuitem" class="no-underline user-profile-link px-3 pt-2 pb-2 mb-n2 mt-n1 d-block" href="https://github.com/kareemassad" data-ga-click="Header, go to profile, text:Signed in as">Signed in as <strong class="css-truncate-target">kareemassad</strong></a></div>
...
<div class="js-user-status-container user-status-compact" data-team-hovercards-enabled="">
    ...
    <summary class="btn-link no-underline js-toggle-user-status-edit toggle-user-status-edit width-full" aria-haspopup="dialog" role="menuitem" data-hydro-click="{&quot;event_type&quot;:&quot;user_profile.click&quot;,&quot;payload&quot;:{&quot;profile_user_id&quot;:5814439,&quot;target&quot;:&quot;EDIT_USER_STATUS&quot;,&quot;user_id&quot;:20263077,&quot;client_id&quot;:&quot;829075131.1537188437&quot;,&quot;originating_request_id&quot;:&quot;F9C9:7E2C:246D09:3DFB18:5C9AF7C2&quot;,&quot;originating_url&quot;:&quot;https://github.com/shantnu/FaceDetect&quot;,&quot;referrer&quot;:&quot;https://realpython.com/face-recognition-with-python/&quot;}}" data-hydro-click-hmac="ecb16bcb03d466207ec0aece045d7e6dc3a8168b4f41c60d250e69c01aa56521">
      ...
      <!-- '"` --><!-- </textarea></xmp> --><form class="position-relative flex-auto js-user-status-form" action="https://github.com/users/status?compact=1&amp;link_mentions=0&amp;truncate=1" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="_method" value="put"><input type="hidden" name="authenticity_token" value="UdrGpXXzirG30ksuQ4ynQXfvoXZLsX2Z/+t/8gW7koY5b1etI+AFT+DaJRTX/0c87ptn11EDbnXqx9U/780qFA==">
        ...
        <div class="d-flex flex-items-center flex-justify-between p-3 border-top">
          ...
          <a role="menuitem" class="dropdown-item" href="https://github.com/kareemassad" data-ga-click="Header, go to profile, text:your profile">Your profile</a>
          <a role="menuitem" class="dropdown-item" href="https://github.com/kareemassad?tab=repositories" data-ga-click="Header, go to repositories, text:your repositories">Your repositories</a>

          <a role="menuitem" class="dropdown-item" href="https://github.com/kareemassad?tab=projects" data-ga-click="Header, go to projects, text:your projects">Your projects</a>

          <a role="menuitem" class="dropdown-item" href="https://github.com/kareemassad?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">Your stars</a>
  ...
  <li>
      ...
      <a class="social-count js-social-count" href="https://github.com/shantnu/FaceDetect/watchers" aria-label="64 users are watching this repository">
        64
      </a>
</form>
  </li>
  ...
  <span class="author" itemprop="author"><a class="url fn" rel="author" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=5814439" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="https://github.com/shantnu">shantnu</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a data-pjax="#js-repo-pjax-container" href="https://github.com/shantnu/FaceDetect">FaceDetect</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container" itemscope="" itemtype="http://schema.org/BreadcrumbList" aria-label="Repository" data-pjax="#js-repo-pjax-container">
  ...
  <span itemscope="" itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a class="js-selected-navigation-item selected reponav-item" itemprop="url" data-hotkey="g c" aria-current="page" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /shantnu/FaceDetect" href="https://github.com/shantnu/FaceDetect">
    ...
    <span itemscope="" itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a itemprop="url" data-hotkey="g i" class="js-selected-navigation-item reponav-item" data-selected-links="repo_issues repo_labels repo_milestones /shantnu/FaceDetect/issues" href="https://github.com/shantnu/FaceDetect/issues">
  ...
  <span itemscope="" itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a data-hotkey="g p" itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_pulls checks /shantnu/FaceDetect/pulls" href="https://github.com/shantnu/FaceDetect/pulls">
    ...
    <a data-hotkey="g b" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /shantnu/FaceDetect/projects" href="https://github.com/shantnu/FaceDetect/projects">
    ...
    <a class="js-selected-navigation-item reponav-item" data-hotkey="g w" data-selected-links="repo_wiki /shantnu/FaceDetect/wiki" href="https://github.com/shantnu/FaceDetect/wiki">
      <svg class="octicon octicon-book" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M3 5h4v1H3V5zm0 3h4V7H3v1zm0 2h4V9H3v1zm11-5h-4v1h4V5zm0 2h-4v1h4V7zm0 2h-4v1h4V9zm2-6v9c0 .55-.45 1-1 1H9.5l-1 1-1-1H2c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1h5.5l1 1 1-1H15c.55 0 1 .45 1 1zm-8 .5L7.5 3H2v9h6V3.5zm7-.5H9.5l-.5.5V12h6V3z"></path></svg>
      Wiki
</a>
    <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse alerts security people /shantnu/FaceDetect/pulse" href="https://github.com/shantnu/FaceDetect/pulse">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  <div class="repository-content ">
    ...
    <a class="d-none js-permalink-shortcut" data-hotkey="y" href="https://github.com/shantnu/FaceDetect/blob/704a3b6ebf4bafab8630aab30e115ecdbc55540a/face_detect.py">Permalink</a>

    <!-- blob contrib key: blob_contributors:v21:8ee1365f326455fa96ca22966133d14c -->
...
<details class="details-reset details-overlay select-menu branch-select-menu">
  ...
  <details-menu class="select-menu-modal position-absolute" style="z-index: 99;" src="/shantnu/FaceDetect/ref-list/master/face_detect.py?source_action=show&amp;source_controller=blob" preload="" role="menu">
    <include-fragment class="select-menu-loading-overlay anim-pulse">
      ...
      <div id="blob-path" class="breadcrumb flex-auto ml-2">
        <span class="js-repo-root text-bold"><span class="js-path-segment"><a data-pjax="true" href="https://github.com/shantnu/FaceDetect"><span>FaceDetect</span></a></span></span><span class="separator">/</span><strong class="final-path">face_detect.py</strong>
      </div>
      <div class="BtnGroup">
        <a href="https://github.com/shantnu/FaceDetect/find/master" class="js-pjax-capture-input btn btn-sm BtnGroup-item" data-pjax="" data-hotkey="t">
          Find file
        </a>
  ...
  <div class="Box Box--condensed d-flex flex-column flex-shrink-0">
      <div class="Box-body d-flex flex-justify-between bg-blue-light flex-items-center">
        <span class="pr-md-4 f6">
          <a rel="author" data-skip-pjax="true" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=5814439" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="https://github.com/shantnu"><img class="avatar" src="./FaceDetect_face_detect_files/5814439" width="20" height="20" alt="@shantnu"></a>
          <a class="text-bold link-gray-dark lh-default v-align-middle" rel="author" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=5814439" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="https://github.com/shantnu">shantnu</a>
            <span class="lh-default v-align-middle">
              <a data-pjax="true" title="Merge branch &#39;master&#39; of https://github.com/shantnu/FaceDetect" class="link-gray" href="https://github.com/shantnu/FaceDetect/commit/704a3b6ebf4bafab8630aab30e115ecdbc55540a">Merge branch 'master' of</a> <a href="https://github.com/shantnu/FaceDetect">https://github.com/shantnu/FaceDetect</a>
            </span>
        </span>
        <span class="d-inline-block flex-shrink-0 v-align-bottom f6">
          <a class="pr-2 text-mono link-gray" href="https://github.com/shantnu/FaceDetect/commit/704a3b6ebf4bafab8630aab30e115ecdbc55540a" data-pjax="">
            704a3b6
          </a>
          <relative-time datetime="2017-04-23T15:18:27Z" title="Apr 23, 2017, 11:18 AM EDT">on Apr 23, 2017</relative-time>
        </span>
      </div>
    ...
    <li class="Box-row">
      <a class="link-gray-dark no-underline" href="https://github.com/shantnu">
        <img class="avatar mr-1" alt="" src="./FaceDetect_face_detect_files/5814439" width="20" height="20">
        shantnu
</a>    </li>
    <li class="Box-row">
      <a class="link-gray-dark no-underline" href="https://github.com/guruvyasa">
        <img class="avatar mr-1" alt="" src="./FaceDetect_face_detect_files/7962656" width="20" height="20">
        guruvyasa
</a>    </li>
    <li class="Box-row">
      <a class="link-gray-dark no-underline" href="https://github.com/mjhea0">
        <img class="avatar mr-1" alt="" src="./FaceDetect_face_detect_files/2018167" width="20" height="20">
        mjhea0
</a>    </li>
    <li class="Box-row">
      <a class="link-gray-dark no-underline" href="https://github.com/www">
        <img class="avatar mr-1" alt="" src="./FaceDetect_face_detect_files/15486" width="20" height="20">
        www
</a>    </li>
</ul>
        ...
        <span class="">
    <a class="avatar-link" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=5814439" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="https://github.com/shantnu/FaceDetect/commits/master/face_detect.py?author=shantnu">
      <img class="avatar mr-1" src="./FaceDetect_face_detect_files/5814439" width="20" height="20" alt="@shantnu"> 
</a>    <a class="avatar-link" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=7962656" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="https://github.com/shantnu/FaceDetect/commits/master/face_detect.py?author=guruvyasa">
      <img class="avatar mr-1" src="./FaceDetect_face_detect_files/7962656" width="20" height="20" alt="@guruvyasa"> 
</a>    <a class="avatar-link" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=2018167" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="https://github.com/shantnu/FaceDetect/commits/master/face_detect.py?author=mjhea0">
      <img class="avatar mr-1" src="./FaceDetect_face_detect_files/2018167" width="20" height="20" alt="@mjhea0"> 
</a>    <a class="avatar-link" data-hovercard-type="user" data-hovercard-url="/hovercards?user_id=15486" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="https://github.com/shantnu/FaceDetect/commits/master/face_detect.py?author=www">
      <img class="avatar mr-1" src="./FaceDetect_face_detect_files/15486" width="20" height="20" alt="@www"> 
</a>
</span>
...
<div class="Box-header py-2 d-flex flex-justify-between flex-items-center">
  ...
  <div class="d-flex">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="https://github.com/shantnu/FaceDetect/raw/master/face_detect.py">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="https://github.com/shantnu/FaceDetect/blame/master/face_detect.py">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="https://github.com/shantnu/FaceDetect/commits/master/face_detect.py">History</a>
    </div>


    <div>
            <a class="btn-octicon tooltipped tooltipped-nw " href="github-windows://openRepo/https://github.com/shantnu/FaceDetect?branch=master&amp;filepath=face_detect.py" aria-label="Open this file in GitHub Desktop" data-ga-click="Repository, open with desktop, type:windows">
...
<table class="highlight tab-size js-file-line-container" data-tab-size="8">
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu role="menu">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2" style="width:185px">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="https://github.com/shantnu/FaceDetect/blame/704a3b6ebf4bafab8630aab30e115ecdbc55540a/face_detect.py">View git blame</a></li>
          <li><a class="dropdown-item" id="js-new-issue" role="menuitem" href="https://github.com/shantnu/FaceDetect/issues/new">Reference in new issue</a></li>
      </ul>
    </details-menu>
  </details>
  ...
  <details class="details-reset details-overlay details-overlay-dark">
    ...
    <details-dialog class="Box Box--overlay d-flex flex-column anim-fade-in fast linejump" aria-label="Jump to line" role="dialog">
      <!-- '"` --><!-- </textarea></xmp> --><form class="js-jump-to-line-form Box-body d-flex" action="https://github.com/shantnu/FaceDetect/blob/master/face_detect.py" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="✓">
...
<div class="footer container-lg width-full px-3" role="contentinfo">
  ...
  <div id="ajax-error-message" class="ajax-error-message flash flash-error">
    ...
    <script crossorigin="anonymous" integrity="sha512-swMU+i1HvjDMEEGWxTU7rTlGx4VdMdEIurnmdf1PxRalkEWVS9wDsYMlzK9eJE+JNg+dxsD4RJP3YsG2jvqc2Q==" type="application/javascript" src="./FaceDetect_face_detect_files/frameworks-f26ea75c.js.download"></script>
    
    <script crossorigin="anonymous" async="async" integrity="sha512-ELcoQzvMh1v0n9tV0v4DZxtFa46TCS7cmssLC00qGX9qWsD82GDH4PZEu/ShNNqIdwXCCuRptNs3IQ8QuHqqIA==" type="application/javascript" src="./FaceDetect_face_detect_files/github-bootstrap-be1f09c7.js.download"></script>
    
    
    
  <div class="js-stale-session-flash stale-session-flash flash flash-warn flash-banner" hidden="">
    <svg class="octicon octicon-alert" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M8.893 1.5c-.183-.31-.52-.5-.887-.5s-.703.19-.886.5L.138 13.499a.98.98 0 0 0 0 1.001c.193.31.53.501.886.501h13.964c.367 0 .704-.19.877-.5a1.03 1.03 0 0 0 .01-1.002L8.893 1.5zm.133 11.497H6.987v-2.003h2.039v2.003zm0-3.004H6.987V5.987h2.039v4.006z"></path></svg>
    <span class="signed-in-tab-flash">You signed in with another tab or window. <a href="https://github.com/shantnu/FaceDetect/blob/master/face_detect.py">Reload</a> to refresh your session.</span>
    <span class="signed-out-tab-flash">You signed out in another tab or window. <a href="https://github.com/shantnu/FaceDetect/blob/master/face_detect.py">Reload</a> to refresh your session.</span>
  </div>
